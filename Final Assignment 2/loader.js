...
/* exported "fileLoader" "FileReader" */
...
<div>
  ...
  <br><br>
  <table class="table table-striped table-dark table-sm" v-show="secondArray.length">
    ...
    <tbody>
      <tr v-for="n in firstArray.length">
        <td class="text-center"> {{ firstArray[n-1] }}</td>
        <td class="text-center"> {{ secondArray[n-1] }}</td>
      </tr>
    </tbody>
  </table>
</div>`,
